            ...
            <div className="flex items-center space-x-2 mb-1">
              ...
              {record?.isEncrypted && (
                <div className="group relative">
                  ...
                  <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-popover/80 backdrop-blur-md border border-border rounded text-xs text-popover-foreground opacity-0 group-hover:opacity-100 transition-opacity [var(--color-surface-alt)]space-nowrap z-tooltip">
